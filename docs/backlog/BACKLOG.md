...
- [S] **M1-01 Đăng nhập/đăng xuất/refresh** (cookie httpOnly, argon2, khoá 15' sau 5 lần sai, đổi mật khẩu lần đầu). Seed Manager đầu tiên qua lệnh CLI `python -m app.cli create-manager`.
