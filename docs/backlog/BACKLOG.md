...
- [R] **M1-02 `require(capability)` + scope + `/me`** (roles, capabilities, counters); ma trận RBAC sinh tự động. Spec `M1-02-authz-scope-me.md`.
- [S] **M1-03 AppShell theo vai trò**: sidebar 2 cấp, drawer mobile, bottom nav, menu từ `/me`, trang 403/404, route guard. Spec `M1-03-app-shell.md`.
