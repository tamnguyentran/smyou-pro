...
- [~] **M1-04a Quản lý nhân viên — API**: danh sách/tìm/lọc, tạo, sửa, gán nhiều vai trò, khoá/mở, cấp lại mật khẩu; không gỡ Manager cuối cùng. Spec `M1-04a-employees-api.md`.
