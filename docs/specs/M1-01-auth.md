# M1-01 — Đăng nhập, đăng xuất, làm mới phiên, đổi mật khẩu lần đầu

- **Status:** Draft
- **Backlog:** M1-01 · **Milestone:** M1
...
- Trong:
  ...
  - Frontend: trang Đăng nhập, trang Đổi mật khẩu bắt buộc, client API tự làm mới phiên khi gặp 401.
...
**Đề xuất tách để giữ diff ≤ ~400 dòng (CLAUDE.md #12):** M1-01a = backend (DB, API, CLI, AC-AUTH-001…019); M1-01b = giao diện + E2E (AC-AUTH-020…026). Xem Q24.
...
## 8. Giả định & câu hỏi (cần chủ dự án quyết định — đã ghi Q19–Q24 trong OPEN_QUESTIONS)
